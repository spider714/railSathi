  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        >
          {delayPositive ? `+${journey.delayMinutes} ${isHi ? 'मि. विलंब' : 'min late'}` : (isHi ? 'समय पर' : 'On time')}
        </span>
      </div>
      ...
      <div>
        ...
        <div className="h-2 w-full rounded-full bg-slate-200 dark:bg-slate-800 overflow-hidden">
          <motion.div
            ...
            className="h-full rounded-full bg-gradient-to-r from-pink-500 to-rail-blue"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        {[
          { icon: Gauge, value: `${journey.speedKmh} km/h`, label: isHi ? 'गति' : 'Speed' },
          { icon: Activity, value: `${journey.distanceCoveredKm} km`, label: isHi ? 'तय दूरी' : 'Covered' },
          { icon: Clock, value: journey.ETA, label: isHi ? 'अनुमानित समय' : 'ETA' },
