...
export default function FavoritesPage() {
  ...
  return (
    <div className="space-y-8 py-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">
            {isHi ? 'मेरी पसंदीदा ट्रेनें' : 'My Favorites'}
          </h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            {isHi
              ? `${favorites.length} सहेजी गई ट्रेनें`
      ...
      {favorites.length === 0 ? (
        <EmptyState
          title={isHi ? 'कोई पसंदीदा ट्रेन नहीं है' : 'No favorites yet'}
          description={
            isHi
              ? 'त्वरित पहुंच के लिए लाइव ट्रैकिंग पेज से किसी भी ट्रेन के दिल आइकन (Heart) पर क्लिक करके सहेजें।'
              : 'Heart any train from the live tracking page to save it here for quick access.'
          }
          action={
            <Link
              href="/"
            ...
            >
              ...
              {isHi ? 'ट्रेनें खोजें' : 'Search Trains'}
            </Link>
          }
        />
      ) : (
